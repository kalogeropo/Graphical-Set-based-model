...
if menu == 1:
    ...
    with open('figures/allq/avarage.txt', 'a') as fd:
       ...
       #########TEST###########
        fd.write('#------Doukas with CoreRank method and Constant Window\n')
...
#here we write the results to excel in order for automation with perpose of further editing
        ...
        df = pd.DataFrame.from_dict({"set based":av_precision,"doukas":av_precision_gsb,"maincore":av_precision_gsb_mc,
                                     "density":av_precision_gsb_dens,"CoreRank":av_precision_gsb_coreRank,"Constan WIndow":av_precision_constant,"Gsb-set":setMdouk
                                     ,"main-set":setMmain,"dens-set":setMdens,"Corerank-set":setMcr, "Constant_Window-set":setMcon})
